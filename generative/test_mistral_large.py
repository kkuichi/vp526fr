...
def evaluate_task(task_name, dataset_config, prompt_fn, parse_fn, split="test"):
    ...
    path = os.path.join(RESULTS_DIR, f"{task_name}_mistral_large.json")
...
with open(os.path.join(RESULTS_DIR, "sts_mistral_large.json"), "w", encoding="utf-8") as f:
...
with open(os.path.join(RESULTS_DIR, "summary_mistral_large.json"), "w", encoding="utf-8") as f:
